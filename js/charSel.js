...
let userChar = document.getElementById("rollChar");
let spanChar = document.getElementById("charSel");

userChar.onclick = function() {
    let randomIndex = Math.floor(Math.random() * leagueOfLegendsChampions.length);
    let randomChamp = leagueOfLegendsChampions[randomIndex];
    
    spanChar.textContent = randomChamp;
}
